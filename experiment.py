...
def main():
    ...
    print solver.solve_SLSQP(feasible_sequence,deepcopy(activities_list))
    print heuristic_end_favoring(feasible_sequence, deepcopy(activities_list))
    ...
    print heuristic_ending_favoring_with_ranking(feasible_sequence,deepcopy(activities_list))
            # experiment_data=[]
